...
public class LokkitIntents {
    ...
    public final static String RECOVER_ACCOUNT = "io.lokkit.RECOVER_ACCOUNT"; // service wants to recover an account. Service sends this as long as the login fails.
    ...
    public final static String GAS_EXTRA = "gas";
    public final static String GASPRICE_EXTRA = "gasPrice";
