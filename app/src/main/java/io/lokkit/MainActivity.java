...
public class MainActivity extends AppCompatActivity
    ...
    private String mnemonic = "brave detect hover blanket since riot salmon diesel shed fiscal circle ghost";
    private String password = "hirzel";
    private String address = "0x298345dddd494c51061da2ae137df3129ce14b69";
    private String host = "http://localhost:8545/";
    ...
    private void doStartNode() {
        ...
        String rec = Statusgo.RecoverAccount(password, mnemonic);
        String logon = Statusgo.Login(address, "hirzel");
